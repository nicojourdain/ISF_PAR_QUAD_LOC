MODULE iom
   ...
   USE isf_oce  , ONLY :   nn_isfpar_basin           !  !: number of basins for ice shelf melt param
#if defined key_si3
   USE ice      , ONLY :   jpl
#endif
...
CONTAINS
   ...
   SUBROUTINE iom_init( cdname, kdid, ld_closedef )
      ...
      INTEGER           :: inum, kbas
      !
      REAL(wp), ALLOCATABLE, DIMENSION(:)   :: zbasinID
...
# endif
         ...
         DO kbas=1,nn_isfpar_basin
           zbasinID(kbas) = kbas
         ENDDO
         CALL iom_set_axis_attr( "nisfbas", zbasinID )
         !
